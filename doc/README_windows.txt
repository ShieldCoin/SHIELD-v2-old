...
Intro
-----
SHIELD is a free open source project derived from PPCoin, with
...
After completing windows setup then run windows command line (cmd)
  cd daemon
  SHIELDd
You would need to create a configuration file SHIELD.conf in the default
wallet directory. Grant access to SHIELDd.exe in anti-virus and firewall
...
SHIELDd backupwallet <destination_backup_file>
Then shutdown ppcoind by
SHIELDd stop
Start up the new SHIELDd (0.3.0).
