...
void Serveur::readServeur()
{
    ...
    foreach(QString msg,list)
    {
        ...
        else
        {
            ...
            if((splitMsg.size() > 7 && (splitMsg.at(3)+splitMsg.at(4)+splitMsg.at(5)+splitMsg.at(6)+splitMsg.at(7)).toStdString() == "#SHIELD:Endof/NAMESlist.") ||
                (splitMsg.size() > 7 && (splitMsg.at(3)+splitMsg.at(4)+splitMsg.at(5)+splitMsg.at(6)+splitMsg.at(7)).toStdString() == "#SHIELD:Endof/WHOlist.") ||
