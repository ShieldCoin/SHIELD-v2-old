...
chmod 777 ~/SHIELD/src/leveldb/build_detect_platform
...
if [ -e ~/SHIELD/src/qt/SHIELD-qt ]; then
...
sudo strip ~/SHIELD/src/SHIELDd
sudo strip ~/SHIELD/src/qt/SHIELD-qt
sudo make install
else
echo "Compile fail not SHIELD-qt present"
fi
...
sudo cp ~/SHIELD/src/qt/res/icons/SHIELD.png /usr/share/icons/
echo '#!/usr/bin/env xdg-open''\n'"[Desktop Entry]"'\n'"Version=1.0"'\n'"Type=Application"'\n'"Terminal=false"'\n'"Icon[en]=/usr/share/icons/SHIELD.png"'\n'"Name[en]=SHIELD"'\n'"Exec=SHIELD-qt"'\n'"Name=SHIELD"'\n'"Icon=/usr/share/icons/SHIELD.png"'\n'"Categories=Network;Internet;" > ~/Desktop/SHIELD.desktop
sudo chmod +x ~/Desktop/SHIELD.desktop
sudo cp ~/Desktop/SHIELD.desktop /usr/share/applications/SHIELD.desktop
sudo chmod +x /usr/share/applications/SHIELD.desktop

# Erase all SHIELD compilation directory , cleaning
...
SHIELD-qt
cp ~/.SHIELD/wallet.dat ~/SHIELDwallet.bak
